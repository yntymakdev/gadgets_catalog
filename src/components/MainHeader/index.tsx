...
import { AsideMenu } from '../AsideMenu/Aside';
          ...
          <div className={styles.content}>
            ...
            <div className={styles.list}>
              <NavigationButton href="/favorites">
                {!!favorites.length && <span className={styles.counter}>{favorites.length}</span>}
                <img className={styles.icon} src={favoriteIcon} alt="favorites" />
              </NavigationButton>
              <NavigationButton href="/cart">
                {!!cart.length && <span className={styles.counter}>{totalItems}</span>}
