...
import { PriceInfo } from '../ProductCards/ProductCard/PriceInfo/PrcieInfo';
...
export const ProductDetailPurchase: React.FC<Props> = ({ productDetail, products }) => {
    ...
    <div className={styles.productDescription}>
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.descriptions}>
          ...
          <p className={cn(styles.description, styles['description--active'])}>{normalizeRam}</p>
        </div>
      </div>
    </div>
  );
