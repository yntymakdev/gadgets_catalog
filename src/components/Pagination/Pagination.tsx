...
import { DEFAULT_PAGE } from '../../constans/pagination';
...
export const Pagination: React.FC<Props> = ({ total, perPage, defaultPage = DEFAULT_PAGE }) => {
  ...
  return (
    <div className={styles.pagination}>
      <button onClick={handlePrevPage} className={cn(styles.button, styles['button--primary'])}>
        <IconLeft fill="white" />
      </button>
      ...
      <button onClick={handleNextPage} className={cn(styles.button, styles['button--primary'])}>
