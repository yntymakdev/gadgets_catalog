...
import { decreaseQuantity, deleteProduct, increaseQuantity } from '../../redux/slices/cartSlice';
...
export const CartItem: React.FC<Props> = ({ id, name, image, price, quantity }) => {
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.quantitiesWrapper}>
          <div className={styles.quantities}>
            <button onClick={handleDecreaseQuantity} className={styles.buttonQuantity}>
              <IconMinus />
            </button>
            <p className={styles.quantity}>{quantity}</p>
            <button
              onClick={handleIncreaseQuantity}
              className={cn(styles.buttonQuantity, styles['buttonQuantity--active'])}>
              <IconPlus />
            </button>
          </div>
