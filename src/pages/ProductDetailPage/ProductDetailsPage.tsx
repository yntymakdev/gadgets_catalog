...
import { AboutProductDetail } from '../../components/AboutProductDetail/AboutProductDetail';
import { Breadcrumbs } from '../../components/BreadCrumbs/BreadCrumbs';
import { Loader } from '../../components/Loader/Loader';
import { ProductDetailPictures } from '../../components/ProductDetailPictures/ProductDetailPictures';
import { ProductDetailPurchase } from '../../components/ProductDetailPurchase/ProductDetailPurchase';
...
export const ProductDetailsPage = () => {
  ...
  return (
    <>
      <Breadcrumbs category={productDetail?.category} productName={productDetail?.name} />
      ...
      <section className={cn(styles.productWrapper, styles.productWrapperPrimary)}>
